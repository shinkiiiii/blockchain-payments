...
export default function Header({handleLoginClick}) {
    ...
    return (
        <nav>
            ...
            <div>
                <ul id="narbar">
                    <li><a className="active" href="/">Khách sạn</a></li>
            ...
            <div >
                <Button className="btn" variant="contained" style={{marginRight:"5px"}} onClick={handleClick}>Log in</Button>
                <Button className="btn" variant="contained" onClick={handleClick}>Sign up</Button>
            </div>
